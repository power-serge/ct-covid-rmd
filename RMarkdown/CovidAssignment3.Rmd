...
geom_bar(stat = "identity", fill="steelblue") + ggtitle("Total Daily Cases") +
theme(legend.position = "none") + labs(x = " ", y = "Cases")
barcases
...
geom_bar(stat="identity", fill="black") + ggtitle("Total Daily Deaths") +
theme(legend.position = "none") + labs(x = " ", y = "Deaths")
bar_deaths
...
geom_bar(stat="identity", fill="orange") + ggtitle("Total Daily Hospitalizations") +
theme(legend.position = "none") + labs(x = " ", y = "Hospitalizations")
bar_hospitilization
