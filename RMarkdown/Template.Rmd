---
title: "`r params$data` - [CT COVID 19 Data](./index.html)"
...
### Previous Daily Cases (Full Gauge Indicates 100 cases or more)
```{r, echo=FALSE, message=FALSE}
previous_daily_case <- daily_cases[length(daily_cases)-1]
gauge(previous_daily_case, min = 0, max = 100, symbol = '', gaugeSectors(
success = c(0, 10), warning = c(10,20), danger = c(20,200), colors = c("primary", "warning", "danger")
))
```

### Latest Daily Cases (Full Gauge Indicates 100 cases or more)
...
### Previous Daily Deaths (Full Gauge Indicates 50 deaths or more)

```{r, echo=FALSE, message=FALSE}
previous_daily_deaths <- daily_deaths[length(daily_deaths)-1]
gauge(previous_daily_deaths, min = 0, max = 50, symbol = '', gaugeSectors(
success = c(0, 5), warning = c(5,10), danger = c(10,200), colors = c("primary", "warning", "danger")
))
```

### Latest Daily Deaths (Full Gauge Indicates 50 deaths or more)
