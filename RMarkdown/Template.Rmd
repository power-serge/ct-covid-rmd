...
window.onload = function () {
  ...
  var tabs = document.querySelectorAll(".navbar-left > li > a");
...
### Previous Daily Cases (30 day high = `r highest_30day_cases`) 
```{r, echo=FALSE, message=FALSE}
...
### Previous Daily Deaths (30 day high = `r highest_30day_deaths`) 
